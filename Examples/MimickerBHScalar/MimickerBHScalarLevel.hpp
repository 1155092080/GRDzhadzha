...
#ifndef MIMICKERBHSCALARLEVEL_HPP_
#define MIMICKERBHSCALARLEVEL_HPP_
...
*/
class MimickerBHScalarLevel : public GRAMRLevel
{
    friend class DefaultLevelFactory<MimickerBHScalarLevel>;
...
#endif /* MIMICKERBHSCALARLEVEL_HPP_ */
